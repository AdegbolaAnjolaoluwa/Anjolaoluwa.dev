...
/**
 * FuzzyText: canvas-rendered text with a per-scanline "fuzz" displacement
 * that intensifies on hover. Adapted from React Bits to TypeScript and wired
 * to inherit the surrounding font (Geist) and theme.
 *
 * Extended so `canvas` can carry a cleanup handle without using `any`.
 */
