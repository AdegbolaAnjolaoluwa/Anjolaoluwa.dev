...
/**
 * DecryptedText, adapted from React Bits to TypeScript.
 * Uses the app's existing framer-motion (the source shipped importing the
 * standalone `motion/react`; framer-motion exposes the same API).
 */
